        ...
        <ScaffoldColumn className="mx-auto w-full max-w-md">
          <header>
            ...
            <Markdown
              ...
              content={`Choose the SupaDash organization you wish to install in`}
            />
          </header>
          <CreateProject />
          <Alert withIcon variant="info" title="You can uninstall this Integration at any time.">
            <Markdown
              content={`You can remove this integration at any time via Vercel or the SupaDash dashboard.`}
            />
          </Alert>
        </ScaffoldColumn>
      </ScaffoldContainer>
...
const CreateProject = () => {
  ...
  return (
    <div>
      <p className="mb-2">SupaDash project details</p>
      <div className="py-2">
        <Input
          autoFocus
          id="projectName"
