  ...
  return (
    <APIAuthorizationLayout>
      <div className={`flex flex-col items-center justify-center h-full`}>
        {device_code ? (
          <>
            <h2 className="py-2">Your SupaDash Account is being used to login on the CLI.</h2>
            <p>Enter this verification code on the CLI to authorize login.</p>
            ...
            <Admonition
              type="tip"
              title="Browser login flow requires a more recent version of the CLI."
              className="mt-16"
            />
          </>
        ) : (
