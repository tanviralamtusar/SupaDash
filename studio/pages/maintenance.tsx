...
const MaintenancePage: NextPageWithLayout = () => {
  ...
  const imgUrl = useMemo(
    () =>
      isDarkMode ? `${BASE_PATH}/img/supadash-full-white.png` : `${BASE_PATH}/img/supadash-full-black.png`,
    [isDarkMode]
  )
  ...
  return (
    <>
      <Head>
        <title>SupaDash | Under Maintenance</title>
      </Head>
      <div className="flex flex-col items-center gap-6 text-center">
        <div className="flex items-center justify-center mb-4">
          <img src={imgUrl} alt="SupaDash" className="h-8" />
        </div>
        ...
        <p className="text-sm text-foreground-lighter max-w-xs mx-auto">
          ...
          <a
            href="mailto:support@supadash.io"
