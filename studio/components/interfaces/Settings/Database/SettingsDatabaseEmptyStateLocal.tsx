      ...
      <Card>
        ...
        <CardContent>
          <p className="prose [&>code]:text-xs text-sm max-w-full">
            Change settings in <code>supadash/config.toml</code> file, which is automatically loaded
            on <code>supadash start</code>
          </p>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <p className="prose [&>code]:text-xs space-x-1 text-sm max-w-full">
            ...
            <a
              ...
              href="https://github.com/tanviralamtusar/SupaDash/blob/main/docker/.env.example"
            >
              .env file
            </a>
            <span>and</span>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://github.com/tanviralamtusar/SupaDash/blob/main/docker/docker-compose.yml"
            >
              docker-compose.yml
            </a>
          </p>
