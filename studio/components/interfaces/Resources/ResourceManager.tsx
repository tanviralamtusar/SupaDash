...
export const ResourceManager = ({ projectRef: ref }: ResourceManagerProps) => {
  const { data: resources, isLoading: isLoadingResources } = useProjectResourcesQuery(ref)
  const { data: analysis, isLoading: isLoadingAnalysis } = useProjectAnalysisQuery(ref)
  const { mutate: updateResources, isPending: isUpdating } = useUpdateProjectResourcesMutation()
