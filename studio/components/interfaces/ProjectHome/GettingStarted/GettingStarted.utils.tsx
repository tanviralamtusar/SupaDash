  ...
  return [
    {
      ...
      description:
        'To get started, install the CLI—our command-line toolkit for managing projects locally, handling migrations, and seeding data—using the npm command below to add it to your workspace.',
      actions: [
        {
      ...
      actions: [
        ...
        },
        {
          ...
          onClick: () =>
            openAiChat(
              'Design my database',
              'Help me create a schema file for my database. We will be using declarative schemas which you can learn about by searching docs for declarative schema.'
            ),
        },
      ],
    },
      ...
      actions: [
        ...
        },
        {
          ...
          onClick: () =>
            openAiChat(
              'Generate seed data',
              'Generate SQL INSERT statements for realistic seed data that I can run via the CLI.'
            ),
        },
      ],
    },
