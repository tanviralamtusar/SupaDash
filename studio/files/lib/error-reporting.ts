...
const WHITELIST_ERRORS = [
  ...
  'Project creation in the SupaDash dashboard is disabled for this Vercel-managed organization.',
  'Your account, which is handled by the Fly SupaDash extension, cannot access this endpoint.',
